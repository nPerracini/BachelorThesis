...
The code provides 2 plots:
      1. X-Axis: Time, Y-Axis: Intensity; This plot contains both AD Leonis and referenc star data and shows a brightness                 curve.
      2. X-Axis: Time, Y-Axis: Intensity; This plot contain the normalized intensity of AD Leonis and shows a brightness                  curve.
...
The code provides 1 plot:
      1. X-Axis: pixel, Y-Axis: pixel; This plot contains the exposure. Marked are both stars, the red square is searched                 for the centroid, the inner annulus contains the area over which intensity is summed over, the band between                  annulus 2 and 3 contains the area over which the background radiation is measured.
This file needs hardcoded values for where the stars are in the image, in order to find the centroid.
...
+ Spectrum
 ...
 The code provides 1 plot:
      1. X-Axis: Time, Y-Axis: Intensity; This plot shows the changing intensity over time and shows a brightness curve.  
 Adjust the name of the input folder if needed.
 ...
 The code provides 1 plot:
      1. X-Axis: Wavelength, Y-Axis: Factor; This plot shows the factor needed at each wavelength.  
 Adjust the name of the input folder if needed.
 ...
 The code allows 6 plots:
      1. X-Axis: Wavelength, Y-Axis: Intensity; This plot shows the spectrum of a measurement. (Inside create_spectrum                  function)
      2. X-Axis: Wavelength, Y-Axis: Intensity; This plot shows a zoomed spectrum around the H-Alpha line of a measurement.             (Inside create_spectrum function)  
      3. X-Axis: Time, Y-Axis: Intensity; This plot shows the intensity summed over the H-Alpha line and a reference window             for different window sizes. (flux_plot function)
      4. X-Axis: Time, Y-Axis: Intensity; This plot shows the normalized intensity over the H-Alpha line for different                  window sizes. (flux_plot function)
      5. X-Axis: Wavelength, Y-Axis: Time/Intensity; This plot shows all spectra plotted above one another.                             (stacked_spectra_plot function)
      6. X-Axis: Wavelength, Y-Axis: Intensity; This plot shows the H-Alpha intensity for a collection of measurements. The             index of the measurements need to be hardcoded. (flare_plot function)
...
The code provides 2 plots:
      1. X-Axis: pixel, Y-Axis: pixel; This plot shows a corrected and added up frame of the exposures.
      2. X-Axis: Wavelength, Y-Axis: Intensity; This plot shows the master spectrum of the object.
...
The code provides 2 plots:
      1. X-Axis: pixel, Y-Axis: pixel; This plot shows a corrected and added up frame of the exposures.
      2. X-Axis: Wavelength, Y-Axis: Intensity; This plot shows the spectrum of the neon exposure. The detected peaks are               marked with x.
Adjust name of input folder if needed.
